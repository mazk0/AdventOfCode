...
const string dayNineDataFilePath = "/workspaces/AdventOfCode/Data2022/DayNineData.txt";

Console.WriteLine(nameof(NineOne));
Console.WriteLine(NineOne.CalculateVisitedCount(dayNineDataFilePath));
Console.WriteLine("---");
...
const string dayTenDataFilePath = "/workspaces/AdventOfCode/Data2022/DayTenData.txt";
...
const string dayElevenDataFilePath = "/workspaces/AdventOfCode/Data2022/DayElevenData.txt";

Console.WriteLine(nameof(ElevenOne));
Console.WriteLine(ElevenOne.GetLevelOfMonkeyBusiness(dayElevenDataFilePath));
Console.WriteLine("---");
Console.WriteLine(nameof(ElevenTwo));
Console.WriteLine(ElevenTwo.GetLevelOfMonkeyBusiness(dayElevenDataFilePath));