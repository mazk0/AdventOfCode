...
{
    public static int GetTotalSize(string dataFilepath)
    {
        ...
        return CalculateTotalSize(directoriesAndSize);
    }
    ...
    private static int CalculateTotalSize(Dictionary<string, int> directoriesAndSize)
    {
        return directoriesAndSize.Values.Where(value => value <= 100000).Sum();
    }
}